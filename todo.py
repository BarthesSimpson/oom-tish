...
def compute_content_cost(a_C, a_G):
    ...
    a_C_unrolled = tf.reshape(tf.transpose(a_C), (1, n_H, n_W, n_C))
    a_G_unrolled = tf.reshape(tf.transpose(a_G), (1, n_H, n_W, n_C))
...
content_image = scipy.misc.imread("images/homies.jpg")
...
style_image = scipy.misc.imread("images/guernica.jpg")
